CREATE TABLE robo_advisor_tt.fact_benchmark
WITH (
format = 'PARQUET',
external_location = 's3://mgmt59900-group1-robo-advisor-tt/curated/fact_benchmark/'
) AS
WITH unioned AS (
SELECT
ticker,
...
ingestion_date
FROM robo_advisor_tt.raw_benchmark
UNION ALL
SELECT
ticker,
CAST("date" AS date) AS price_date,
